...
![Установка пакетов для MariaDB](image/image1.png){#fig:001 width=70%}
...
![Проверка прослушивания порта 3306](image/image2.png){#fig:002 width=70%}
...
![Списки команд MySQL и баз данных](image/image4.png){#fig:004 width=70%}
